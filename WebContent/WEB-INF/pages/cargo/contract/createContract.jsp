					...
					<table class="commonTable" cellspacing="1">
						<tr>
							...
							<td class="tableContent"><input type="text" name="offeror"
								value="翊华集团龙力电子商务有限公司" /></td>
							<td class="columnTitle">打印版式：</td>
							<td class="tableContentAuto"><input type="radio"
								name="printStyle" value="2" checked class="input">两个货物 <input
								type="radio" name="printStyle" value="1" class="input">一个货物
							</td>
						</tr>
						<tr>
							<td class="columnTitle_mustbe">客户名称：</td>
							<td class="tableContent"><input type="text"
								name="customName" value="" /></td>
							<td class="columnTitle_mustbe">合同号：</td>
							<td class="tableContent"><input type="text"
								name="contractNo" value="" /></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="tableContentAuto"><input type="radio"
								name="importNum" value="3" checked class="input">★★★ <input
