...
<li id="delete"><a href="#" onclick="formSubmit('delete.action','_self');this.blur();">批删</a></li>
...
<table id="ec_table" class="tableRegion" width="98%" >
	...
	<c:forEach items="${fList}" var="o" varStatus="status">
	<tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'" >
		...
		<td>${o.fax}</td>
		<td>${o.inspector}</td>
		<td><c:if test="${o.state == 0}"><a href="start.action?id=${o.id }"><font color="grey">停用</font></a></c:if>
