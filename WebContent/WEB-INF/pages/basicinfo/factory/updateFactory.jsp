					...
					<table class="commonTable" cellspacing="1">
						<tr>
							...
							<td class="tableContent"><input type="text" name="orderNo"
								value="${obj.orderNo}" dataType="整数" dispName="排序号" /></td>
